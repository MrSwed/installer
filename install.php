...
$InstallData = array(
	'master' => array(
		'tree' => 'Evolution',
		'name' => 'Evolution CMS 1.3 and newer (last stable version)',
		'link' => 'https://github.com/evolution-cms/evolution/archive/master.zip',
		'location' => 'install/index.php'
	),
	'develop' => array(
		'tree' => 'Evolution',
		'name' => 'Evolution CMS (develop version)',
		'link' => 'https://github.com/evolution-cms/evolution/archive/develop.zip',
	    'location' => 'install/index.php'
	),
		'modx_origin' => array(
		'tree' => 'Modx Evo',
...
<body>
	<div class="header">
		...
		<h1 class="main-heading"><span>EVO(MODX) CMS </span> Installer <sup>v'.$version.'</sup> </h1>
...
<div class="content">';
echo '<h2>Choose CMS version for Install:</h2>
	<form>';
